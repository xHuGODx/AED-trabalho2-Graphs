...
unsigned long InstrCount[NUMCOUNTERS] = {0,0,0,0};
...
char* InstrName[NUMCOUNTERS] = {"Iteracoes" , "DegreeUptd", "InDegreeComp", "DAGcess"};  ///extern
    /* Iteraçoes: Numero de iteraçoes 
       DegreeUptd: Numero de vezes que o grau de um vertice foi atualizado
       InDegreeComp: Numero de vezes que o grau de um vertice foi comparado com 0
       DAGcess: Acessos à memória relativa ao grafo
    */
